-- Master Migration: Brand-Shared Coupon System with Referral Tracking
-- Description: Complete migration for implementing brand-specific shared coupons
-- Date: 2026-03-11
-- Author: Claude Code

-- This migration adds support for brand-shared coupons where:
-- - Multiple influencers share one coupon code (e.g., SNITCHCOLLABKAROO)
-- - Each influencer has a unique referral code for attribution (e.g., INFL15)
-- - Brands track conversions via referral codes in webhooks
...
-- =============================================================================
\echo 'Creating hype_store_referral_codes table...'
...
\echo '✓ hype_store_referral_codes table created'

-- =============================================================================
-- STEP 2: Create hype_store_referral_clicks table
-- =============================================================================
\echo 'Creating hype_store_referral_clicks table...'
...
\echo '✓ hype_store_referral_clicks table created'

-- =============================================================================
-- STEP 3: Update hype_store_coupon_codes for brand-shared coupons
-- =============================================================================
\echo 'Updating hype_store_coupon_codes table...'

-- Make influencer_id nullable
...
-- =============================================================================
\echo 'Updating hype_store_orders table...'
