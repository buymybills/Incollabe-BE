...
export class AuthService {
  ...
  async brandCompleteProfile(
    ...
    const updatedData = {
      ...
      ...(profileDto.pocName != null && { pocName: profileDto.pocName }),
      ...(profileDto.pocDesignation != null && { pocDesignation: profileDto.pocDesignation }),
      ...(profileDto.pocEmailId != null && { pocEmailId: profileDto.pocEmailId }),
      ...(profileDto.pocContactNumber != null && { pocContactNumber: profileDto.pocContactNumber }),
      ...(profileDto.brandBio != null && { brandBio: profileDto.brandBio }),
